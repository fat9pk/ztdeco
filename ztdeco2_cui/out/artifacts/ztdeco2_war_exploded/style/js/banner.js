    ...
    d.fn.responsiveSlides = function (h) {
        ...
        return this.each(function () {
            ...
            if (1 < f.size()) {
                ...
                if (b.nav) {
                    c = "<div class='rslides_div container'><a href='#' class='" + y + " prev'>" + b.prevText + "</a><a href='#' class='" + y + " next'>" + b.nextText + "</a></div>";
                    h.controls ? d(b.controls).append(c) : e.after(c);
                    var c = d("." + g + "_nav"), B = d("." + g + "_nav.next");
...
$(function () {
    $(".rslides").responsiveSlides({auto: true, pager: false, nav: true, speed: 800,});
});